...
#cv-entry(
  ...
  "Aug 2024 -- Present (Expected date of Graduation: May 2028)"
)
...
- *Computation:* Python, Julia; numerical methods (finite differences, Runge-Kutta), data analysis, visualization
