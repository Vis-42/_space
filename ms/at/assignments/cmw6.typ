...
#solution[
  ...
  #boxed[$ vb(F)(t) = dv(vb(P), t) = lim_(Delta t -> 0) (Delta vb(P))/(Delta t) = (vb(v) - vb(u)) dot(m)(t) $]
]
...
#solution[
  *Given:* $vb(g) = -g vu(e)_z$, $vb(u) = -u vu(e)_z$, $dot(m)(t) = -k$ $arrow.r$ $m(t) = m_0 - k t$
  ...
  #boxed[$ v_z (t) = -g t - u ln ((m_0 - k t)/(m_0)) $]

  #boxed[$ z(t) = -1/2 g t^2 + u t + u/k (m_0 - k t) ln ((m_0 - k t)/(m_0)) $]
]
...
#solution[
  *Given:* $vb(r) = x vu(e)_x + y vu(e)_y$, $sigma(vb(r)) = sigma(x,y) = sigma_0 (x y)/(a b)$
  ...
  #boxed[$ vb(R)_"CM" = 2/3 a vu(e)_x + 2/3 b vu(e)_y $]
]
