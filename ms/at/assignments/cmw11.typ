...
#solution[
  *Given relationships:*
  ...
  $ dv(E, t) &= dv(, t) [U(vb(r)(t)) + m/2 dot(vb(r))(t) · dot(vb(r))(t)] \
...
$ grad U(vb(r)) &= 1/h_1 pdv(U(r),r) vu(e)_r + 1/h_2 pdv(U(r),θ) vu(e)_θ + 1/h_3 pdv(U(r),φ) vu(e)_φ \
  ...
  &= dv(, r) [- integral_(r_0)^r f(r') d r'] vu(e)_r = -f(r) vu(e)_r #h(1em)  $

Therefore:
$ vb(F)(vb(r)) = -grad U(vb(r)) = f(r) vu(e)_r #h(1em)  $

*Computing the potential energy:*
$ U(r) &= - integral_(r_0)^r f(r') d r' = - display((Q q)/(4 π ε_0)) integral_(r_0)^r 1/(r'^2) d r' \
  &= - display((Q q)/(4 π ε_0)) lr([- 1/r']_(r_0)^r) = display((Q q)/(4 π ε_0)) lr((1/r - 1/r_0)) #h(1em)  $

#boxed[The electrostatic force is conservative, and the corresponding potential energy is $ U(r) = (Q q)/(4 π ε_0) (1/r - 1/r_0) $.]
]
...
#solution[
  We have,
$ &cases(T(t) = 1/2 m dot(vb(r))(t) · dot(vb(r))(t),
  U(vb(r), t) = - display(integral)_(r_0)^vb(r) vb(F)(vb(r)', t) · d vb(r)')\
  ⟹&cases(d T = m dot.double(vb(r))(t) · dot(vb(r))(t) d t = vb(F)(vb(r)(t), t) · dot(vb(r))(t) d t = -grad U(vb(r)(t), t) · d vb(r),
    d U = grad U(vb(r)(t), t) · d vb(r) + display(pdv(U(vb(r)(t), t),t)) d t) $

So,
$ d E &= d T + d U = pdv(U(vb(r)(t), t),t) d t ⟹  dv(E,t) &= pdv(U(vb(r)(t), t),t) ≠ 0 #h(1em)  $

#boxed[Therefore, when the potential energy has explicit time dependence, the total mechanical energy is *not* conserved.]
]
