...
$ &T(t) - T(0) = W (vb(r)(0) → vb(r)(t)) \
 ...
 &⟹ (d θ(t))/(d t) = - sqrt(2g/L [cos θ(t) - cos θ_0]) \
 &⟹ sqrt(2g/L) integral_0^t d t = - integral_(θ_0)^(θ(t)) (d θ)/(sqrt(cos θ - cos θ_0)) \
 &⟹ sqrt(2g/L) integral_0^t d t = -sqrt(2) integral_(θ_0)^(θ(t)) (d θ)/(sqrt(θ_0^2 - θ^2)) #h(10em) [ because cos θ \u{2248} 1 - θ^2 /2 ] \
 &⟹ sqrt(g/L) integral_0^t d t = - integral_(θ_0)^(θ(t)) (sqrt(1 - display(θ^2/θ_0^2)))^(-1) d (θ/θ_0) \
